...
@section('content')
    ...
    <div class="row">
        @include('admin.pages.dashboard.state',['type'=>1,'title'=>'عدد الوجبات','amount'=>\App\Models\Meal::count()])
        @include('admin.pages.dashboard.state',['type'=>2,'title'=>'عدد مزودي الخدمات','amount'=>\App\Models\Category::count()])
        @include('admin.pages.dashboard.state',['type'=>3,'title'=>'الزوار خلال شهر','amount'=>visits(app('default_lang'))->period('month')->count()])
    </div>
    <div class="row">
